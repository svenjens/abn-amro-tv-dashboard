...
```html
<picture>
  <source media="(min-width: 1280px)" srcset="/optimized/hero-background.webp" type="image/webp" />
  <source
...
<picture>
  ...
  <img src="/optimized/empty-state-illustration.png" alt="No results" class="mx-auto h-48 w-48" />
</picture>
```
